...
export default function AccountInfoScreen() {
  ...
  const [deleteProfile, { isLoading: isDeletingProfile, error: deleteError }] =
    useDeleteProfileMutation();
  ...
  return (
    <View className="flex-1 bg-background">
      ...
      <View className="flex-row items-center justify-between px-4 pt-12 pb-4">
        ...
        <TouchableOpacity
          className="bg-[#9EDD45] py-1 px-2 rounded-lg"
        ...
        <>
          ...
          <View className="mt-8 px-4">
            ...
            <View className="flex-row justify-between">
              ...
              <TouchableOpacity
                className="bg-[#9EDD45] flex-row items-center py-1 px-3 rounded-lg"
                onPress={() => router.push("/profile/edit-profile")}
              >
          ...
          <View className="bg-[#1A2432] p-6 rounded-lg w-5/6 mx-4">
            ...
            <Text className="text-gray-300 mb-6">
              {isDeleteEnabled
                ...
                : `Wait! Are you sure you want to delete? We'll miss you! Confirm in ${deleteCountdown} seconds.`}
            </Text>
            <View className="flex-row justify-end space-x-3">
              ...
              <TouchableOpacity
                className={`px-4 py-2 rounded ${
                  isDeleteEnabled ? "bg-[#9EDD45]" : "bg-gray-500"
                }`}
              ...
              >
                <Text
                  className={`${
                    isDeleteEnabled ? "text-white" : "text-gray-300"
                  }`}
                >

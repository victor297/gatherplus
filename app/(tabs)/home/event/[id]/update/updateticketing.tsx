...
export default function TicketingScreen() {
  ...
  const handleSaveAndContinue = () => {
    ...
    router.push({
      pathname:
        `/(tabs)/home/event/${params.id}/update/updatereview` as RelativePathString,
      params: {
  ...
  return (
    ...
    >
      <View className="flex-row items-center px-4 pt-12 pb-4">
        ...
        <Text className="text-white text-xl font-semibold">Update Tickets</Text>
      </View>
              ...
              <View key={index} className="space-y-4 mb-6 relative">
                ...
                <View>
                  ...
                  <Text className="text-gray-400 mb-3">
                    Existing buyers keep their saved design; changes apply to future purchases.
                  </Text>
                  <TicketDesignSelector
